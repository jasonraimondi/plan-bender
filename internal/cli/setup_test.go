...
func (m *mockValidator) ListWorkflowStates(_ context.Context, _ string) (string, map[string]string, string, error) {
	if m.err != nil {
		return "", nil, "", m.err
	}
	return "team-uuid-1", map[string]string{"Todo": "id-1", "Done": "id-2"}, "notUsed", nil
}
